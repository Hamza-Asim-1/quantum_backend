// updateRenderAdminPassword.js
// Run this script on Render to update the admin password
const bcrypt = require('bcrypt');
const { Pool } = require('pg');
require('dotenv').config();

async function updateRenderAdminPassword() {
  ...
  if (!databaseUrl) {
    ...
    console.error('This script should be run on Render where DATABASE_URL is available');
    process.exit(1);
  }
  ...
  try {
    ...
    console.log('\n🚀 The password is now updated on Render!\n');
